                    ...
                    <div className="mb-4">
                      <div className="flex flex-wrap gap-1">
                        {property.features.slice(0, 3).map((feature, index) => (
                          <span key={index} className="bg-blue-50 text-blue-800 text-xs px-2 py-1 rounded font-medium border border-blue-200">
                            {feature}
                          </span>
                        ))}
                        {property.features.length > 3 && (
                          <span className="bg-blue-50 text-blue-800 text-xs px-2 py-1 rounded font-medium border border-blue-200">
