...
export default function AlquileresPage() {
  ...
  // Datos de ejemplo para propiedades en alquiler
  useEffect(() => {
    const sampleProperties: Property[] = [
      {
        ...
        bathrooms: 1,
        area_m2: 70,
        address: 'Calle Córdoba 456',
        neighborhood: 'Centro',
        images: ['/placeholder.svg'],
        features: ['amueblado', 'aire_acondicionado', 'seguridad']
      },
      {
        id: '2',
      ...
      },
      {
        ...
        neighborhood: 'Centro',
        images: ['/placeholder.svg'],
        features: ['amueblado', 'servicios_incluidos']
      },
      {
        id: '4',
        ...
        bathrooms: 1,
        area_m2: 60,
        address: 'Calle 25 de Mayo 789',
        neighborhood: 'Centro',
        images: ['/placeholder.svg'],
        features: ['vidriera', 'acceso_discapacitados']
      }
    ];
