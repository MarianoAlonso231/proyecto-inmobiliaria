    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        <p className="text-gray-600">
          Se encontraron <span className="font-semibold text-gray-800">{filteredProperties.length}</span> propiedades en alquiler
        </p>
      </div>
...
function AlquileresPageFallback() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
...
export default function AlquileresPage() {
  return (
    <div className="min-h-screen bg-white">
      <Header />
      <Suspense fallback={<AlquileresPageFallback />}>
        <AlquileresContent />
      </Suspense>
      <Footer />
    </div>
